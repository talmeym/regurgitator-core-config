...
public abstract class IdentifySessionLoader {
	protected Step buildIdentifySession(String id, String source, String value, Log log) throws RegurgitatorException {
		int numberSet = 0;
